...
class PermissionsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $createTask->display_name = 'Create activity';
        $createTask->name = 'activity-create';
        $createTask->description = 'Permission to create activity';
        $createTask->save();

        $updateTask = new Permissions;
        $updateTask->display_name = 'Update activity';
        $updateTask->name = 'activity-update';
        $updateTask->description = 'Permission to update activity';
        $updateTask->save();
