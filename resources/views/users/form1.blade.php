            ...
            <div class="col-md-12 col-sm-12">
                ...
                <div class="fileinput fileinput-new text-center" data-provides="fileinput">
                    ...
                    @if($type == 'edit')
                            ...
                            <img src="../resources/assets/images/Media/{{$user->image_path}}" alt="...">
                            @else
    ...
    <div class="col-md-6">
        <div class="form-group">
           ...
           <div class="col-md-6">
             ...
             @if(Entrust::hasRole('administrator'))
             	{!! Form::text('email',null,['class' => 'form-control' , 'id' => 'mail','placeholder'=>'E-Mail...'])!!}
             @else
       ...
       <div class="form-group">
        ...
        <div class="form-group">
               ...
               @elseif(Entrust::hasRole('employee'))
                  <input type="text" name="roles" value="Employee" class="form-control" id="roles" readonly="true" />
               @elseif(Entrust::hasRole('manager'))
                  <input type="text" name="roles" value="Manager" class="form-control" id="roles" readonly="true" />
               @endif
