...
<head>
    ...
    <meta name="description" content="OPAL CRM">
                ...
                <div class="col-md-12">
                    ...
                    <div class="collapse navbar-collapse navbar-right" id="myNavbar">
                        <ul class="nav navbar-nav">
                            ...
                            <li class=""><a href="#" data-toggle="modal" data-target="#signin_modal">Sign In</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="banner-info">
                    <div class="banner-text text-center">
                        <h1 class="white">Opal CRM!!</h1>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod <br>tempor incididunt ut labore et dolore magna aliqua.</p>
                        <a href="#" class="btn btn-appoint" data-toggle="modal" data-target="#signup_modal">Free SignUp.</a>
                    </div>
...
<!--/ banner-->
<div id="signin_modal" class="modal fade modal-customized" role="dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div class="header header-primary text-center">
                    ...
                    <div class="logo">
                        <img src="" alt="" onerror="javascript:$(this).hide();">
                    </div>
                </div>
            </div>
            <div class="modal-body">
                ...
                <a class="btn btn-simple" data-toggle="modal" data-target="#forgotpwd_modal">Forgot Your Password?</a>
                <a class="btn btn-simple" data-toggle="modal" data-target="#signup_modal">Sign Up</a>
            </div>
        </div>
    </div>
</div>
<div id="signup_modal" class="modal fade modal-customized" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            ...
            <div class="modal-body">
                <div class="content">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" name="work_number" placeholder="Reachable Phone...">
                    </div>
                ...
                <a class="btn btn-simple" data-toggle="modal" data-target="#forgotpwd_modal">Forgot Your Password?</a>
                <a class="btn btn-simple" data-toggle="modal" data-target="#signin_modal">Sign In</a>
...
<div id="forgotpwd_modal" class="modal fade modal-customized" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
        ...
        <div class="row">
            ...
            <div class="col-md-4 col-sm-4">
                ...
                <div class="testi-info">
                    <!-- User Image -->
                    <a href="#"><img src="{{asset('img/thumb.png')}}" alt="" class="img-responsive"></a>
                    <!-- User Name -->
    ...
    <div class="container">
        <div class=" row">
            ...
            <div class="col-md-4 col-sm-5">
                ...
                <p class="text-right text-primary"><i>— Opal CRM</i></p>
            </div>
            <div class="col-md-2"></div>
        </div>
    </div>
...
<script src="{{asset('js/page-level/index.js')}}"></script>
