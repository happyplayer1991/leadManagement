...
@if($type == 'create')
    ...
    <div class="col-md-12">
        ...
        <div class="form-group">
            ...
            {!! Form::select('lead_type', $leadtype, null, ['class' => 'form-control lead_status ', 'id' => 'search-select', 'style'=>'width:85%;']) !!}
