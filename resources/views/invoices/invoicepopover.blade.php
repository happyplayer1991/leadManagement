    ...
    <div class="modal-dialog">
        <div class="modal-content " style=" width: 155%; margin-left: -22%;">
            <div class="modal-header">
                ...
                <legend class="modal-title text-center">Add Invoice</legend>
            </div>
...
@section('content')
    ...
    <div class="card">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-4">
                            <div class="form-group label-floating">
                                ...
                                <input type="number" class="form-control" value="{{$quotation->currency}}" readonly>
                            </div>
                        </div>
                    ...
                    <table class="table table-striped">
                        ...
                        @foreach($quotation_items as $items)
                            <tr>
                                ...
                                <td class="">{{$symbol}}{{$items->total}}</td>
                            </tr>
                        @endforeach
                        </tbody>
            ...
            <div class="card-content">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="col-md-6">
                            <p>Total Price:<span>{{$symbol}}{{$quotation->total_price}}</span><input type="hidden" value="{{$quotation->total_price}}" name="total_price"/></p>
                            <p>Discount:<span></span></p>
                            <p>Tax(%):<span>{{$symbol}}{{$quotation->tax_amount}}</span></p>
                            <p>Gross Price:{{$symbol}}<span id="gross_price">{{$quotation->amount}}</span><input type="hidden" value="{{$quotation->amount}}" name="amount"/></p>
                            <p>Paid:<span>{{$symbol}}<input type="text" name="payed" id="payed"/></span></p>
                            <p>Due:<span>{{$symbol}}<input type="text" name="due" id="due"  value="{{$quotation->due_amount}}"/></span></p>
        ...
        <div class="pull-right" style="margin-bottom: 10%;" >
            ...
            <button type="submit" class="btn btn-primary" name="cancel" value="submit">Cancel</button>
        </div>
    </div>
    <div id="modal_window">
    </div>
